...
namespace Project3H04.Server.Data {
    public class DataInitialiser {
        ...
        public void InitializeData() {
            ...
            Kunstwerk kunstwerk1 = new Kunstwerk("Flowers", DateTime.UtcNow, 200, "Beautiful work that inspires", new List<Foto> { new() { Pad = "A1AT1.png" }}, false, "painting", kunstenaar2);
            ...
            Kunstwerk kunstwerk8 = new Kunstwerk("We've found comfort here", DateTime.UtcNow, 200, "Beautiful work that inspires", new List<Foto> { new() { Pad = "InaraA2.png" }}, false, "painting", kunstenaar1);
