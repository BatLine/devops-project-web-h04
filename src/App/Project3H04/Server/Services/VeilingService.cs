...
namespace Project3H04.Server.Services {
    public class VeilingService : IVeilingService {
        ...
        public async Task<bool> CreateVeiling(Veiling_DTO veiling) {
            ...
            var kunstwerk = new Kunstwerk(veiling.Kunstwerk.Naam, veiling.Kunstwerk.Einddatum, veiling.Kunstwerk.Prijs,
                veiling.Kunstwerk.Beschrijving, fotos, veiling.Kunstwerk.IsVeilbaar,
